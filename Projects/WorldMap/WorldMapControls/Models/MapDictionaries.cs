    ...
    public static class MapDictionaries
    {
        ...
        static MapDictionaries()
        {
            ...
            CountryToName = new Dictionary<Country, string>
            {
                ...
                { Country.Georgia, "Georgia" }, // Added Georgia
                { Country.Armenia, "Armenia" }, // Added Armenia
                ...
                { Country.Turkmenistan, "Turkmenistan" }, // Added Turkmenistan
                ...
                { Country.DemocraticRepublicOfCongo, "Democratic Republic of the Congo" },
                { Country.RepublicOfCongo, "Republic of the Congo" },
                ...
                { Country.Somalia, "Somalia" }, // Added Somalia

                // Oceania
                { Country.Australia, "Australia" },
                { Country.NewZealand, "New Zealand" },
                { Country.FijiIslands, "Fiji" },
                ...
                { Country.StVincent, "Saint Vincent and the Grenadines" },
                { Country.Dominica, "Dominica" },
                { Country.AntiguaBarbuda, "Antigua and Barbuda" },
                { Country.StKittsNevis, "Saint Kitts and Nevis" },
                ...
                { Country.CocosIslands, "Cocos Islands" },
                ...
                { Country.SouthGeorgiaAndSouthSandwichIslands, "South Georgia and South Sandwich Islands" },
                { Country.Guam, "Guam" },
            ...
            CountryToContinent = new Dictionary<Country, Continent>
            {
                ...
                { Country.Greenland, Continent.NorthAmerica },
                { Country.Guatemala, Continent.NorthAmerica },
                { Country.Belize, Continent.NorthAmerica },
                { Country.ElSalvador, Continent.NorthAmerica },
                { Country.Honduras, Continent.NorthAmerica },
                { Country.Nicaragua, Continent.NorthAmerica },
                { Country.CostaRica, Continent.NorthAmerica },
                { Country.Panama, Continent.NorthAmerica },
                { Country.Cuba, Continent.NorthAmerica },
                { Country.Jamaica, Continent.NorthAmerica },
                { Country.Haiti, Continent.NorthAmerica },
                { Country.DominicanRepublic, Continent.NorthAmerica },
                ...
                { Country.Paraguay, Continent.SouthAmerica },
                { Country.Uruguay, Continent.SouthAmerica },
                { Country.Guyana, Continent.SouthAmerica },
                { Country.Suriname, Continent.SouthAmerica },
                ...
                { Country.CzechRepublic, Continent.Europe },
                ...
                { Country.BosniaAndHerzegovina, Continent.Europe },
                { Country.NorthMacedonia, Continent.Europe },
                ...
                { Country.Azerbaijan, Continent.Europe }, // Could be Asia, but treating as Europe
                { Country.Iceland, Continent.Europe },
                { Country.Ireland, Continent.Europe },
                { Country.Georgia, Continent.Europe }, // Added Georgia (could be Asia)
                { Country.Armenia, Continent.Asia }, // Added Armenia

                // Asia
                { Country.China, Continent.Asia },
                { Country.Japan, Continent.Asia },
                { Country.SouthKorea, Continent.Asia },
                { Country.NorthKorea, Continent.Asia },
                ...
                { Country.SriLanka, Continent.Asia },
                ...
                { Country.TimorLeste, Continent.Asia },

                // Middle East
                { Country.SaudiArabia, Continent.MiddleEast },
                { Country.Iran, Continent.MiddleEast },
                { Country.Iraq, Continent.MiddleEast },
                { Country.Israel, Continent.MiddleEast },
                { Country.Palestine, Continent.MiddleEast },
                { Country.Jordan, Continent.MiddleEast },
                { Country.Lebanon, Continent.MiddleEast },
                { Country.Syria, Continent.MiddleEast },
                { Country.Yemen, Continent.MiddleEast },
                { Country.Oman, Continent.MiddleEast },
                { Country.UAE, Continent.MiddleEast },
                { Country.Qatar, Continent.MiddleEast },
                { Country.Bahrain, Continent.MiddleEast },
                { Country.Kuwait, Continent.MiddleEast },
                ...
                { Country.DemocraticRepublicOfCongo, Continent.Africa },
                { Country.RepublicOfCongo, Continent.Africa },
                { Country.CentralAfricanRepublic, Continent.Africa },
                { Country.Chad, Continent.Africa },
                { Country.Sudan, Continent.Africa },
                { Country.SouthSudan, Continent.Africa },
                ...
                { Country.IvoryCoast, Continent.Africa },
                { Country.BurkinaFaso, Continent.Africa },
                ...
                { Country.SierraLeone, Continent.Africa },
                { Country.Liberia, Continent.Africa },
                { Country.Gambia, Continent.Africa },
                { Country.GuineaBissau, Continent.Africa },
                ...
                { Country.FijiIslands, Continent.Oceania },
                { Country.PapuaNewGuinea, Continent.Oceania },
                { Country.SolomonIslands, Continent.Oceania },
                { Country.Vanuatu, Continent.Oceania },
                { Country.NewCaledonia, Continent.Oceania },
                { Country.Samoa, Continent.Oceania },
                { Country.Tonga, Continent.Oceania },
                { Country.Palau, Continent.Oceania },
                { Country.MarshallIslands, Continent.Oceania },
                ...
                // Additional commonly missing countries
                { Country.Cyprus, Continent.Europe }, // Could be Asia
                ...
                { Country.SanMarino, Continent.Europe },
                { Country.VaticanCity, Continent.Europe },
                ...
                { Country.CaboVerde, Continent.Africa },
                { Country.Barbados, Continent.NorthAmerica },
                { Country.Trinidad, Continent.NorthAmerica },
                { Country.Grenada, Continent.NorthAmerica },
                { Country.StLucia, Continent.NorthAmerica },
                { Country.StVincent, Continent.NorthAmerica },
                { Country.Dominica, Continent.NorthAmerica },
                { Country.AntiguaBarbuda, Continent.NorthAmerica },
                { Country.StKittsNevis, Continent.NorthAmerica },
                { Country.Bahamas, Continent.NorthAmerica },
                ...
                // Territories and Dependencies
                { Country.Anguilla, Continent.NorthAmerica },
                { Country.Antarctica, Continent.Antarctica },
                { Country.AmericanSamoa, Continent.Oceania },
                { Country.Aruba, Continent.NorthAmerica },
                { Country.AlandIslands, Continent.Europe },
                { Country.SaintBarthelemy, Continent.NorthAmerica },
                { Country.Bermuda, Continent.NorthAmerica },
                { Country.BonaireSintEustatiusAndSaba, Continent.NorthAmerica },
                { Country.BouvetIsland, Continent.Antarctica },
                { Country.CocosIslands, Continent.Asia },
                { Country.CookIslands, Continent.Oceania },
                { Country.Curacao, Continent.NorthAmerica },
                { Country.ChristmasIsland, Continent.Asia },
                { Country.WesternSahara, Continent.Africa },
                { Country.FalklandIslands, Continent.SouthAmerica },
                { Country.FaroeIslands, Continent.Europe },
                { Country.FrenchGuiana, Continent.SouthAmerica },
                { Country.Guernsey, Continent.Europe },
                { Country.Gibraltar, Continent.Europe },
                { Country.Guadeloupe, Continent.NorthAmerica },
                { Country.SouthGeorgiaAndSouthSandwichIslands, Continent.Antarctica },
                { Country.Guam, Continent.Oceania },
                { Country.HongKong, Continent.Asia },
                { Country.HeardIslandAndMcDonaldIslands, Continent.Antarctica },
                { Country.IsleOfMan, Continent.Europe },
                { Country.BritishIndianOceanTerritory, Continent.Asia },
                { Country.Jersey, Continent.Europe },
                { Country.CaymanIslands, Continent.NorthAmerica },
                { Country.SaintMartin, Continent.NorthAmerica },
                { Country.Macao, Continent.Asia },
                { Country.NorthernMarianaIslands, Continent.Oceania },
                { Country.Martinique, Continent.NorthAmerica },
                { Country.Montserrat, Continent.NorthAmerica },
                { Country.NorfolkIsland, Continent.Oceania },
                { Country.Niue, Continent.Oceania },
                { Country.FrenchPolynesia, Continent.Oceania },
                { Country.SaintPierreAndMiquelon, Continent.NorthAmerica },
                { Country.Pitcairn, Continent.Oceania },
                { Country.PuertoRico, Continent.NorthAmerica },
                { Country.Reunion, Continent.Africa },
                { Country.SaintHelenaAscensionAndTristanDaCunha, Continent.Africa },
                { Country.SvalbardAndJanMayen, Continent.Europe },
                { Country.SintMaarten, Continent.NorthAmerica },
                { Country.TurksAndCaicosIslands, Continent.NorthAmerica },
                { Country.FrenchSouthernTerritories, Continent.Antarctica },
                { Country.Tokelau, Continent.Oceania },
                { Country.Taiwan, Continent.Asia },
                { Country.UnitedStatesMinorOutlyingIslands, Continent.Oceania },
                { Country.VirginIslandsBritish, Continent.NorthAmerica },
                { Country.VirginIslandsUS, Continent.NorthAmerica },
                { Country.WallisAndFutuna, Continent.Oceania },
