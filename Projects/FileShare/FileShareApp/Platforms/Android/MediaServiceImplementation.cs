...
namespace FileShareApp.Platforms.Android
{
    public class MediaServiceImplementation : IMediaService
    {
        ...
        private static TaskCompletionSource<string> cameraImagePath;
        ...
        private async Task<IList<MediaAssest>> LoadMediaAsync()
        {
        ...
        private string GetString(ICursor cursor, string key)
        {
